...
public class XSSExcelTool<T> {
     ...
     * @param dateFormat
     */
    public XSSExcelTool(String title, int colWidth, int rowHeight, String dateFormat) {
    ...
    public XSSExcelTool(String title, int colWidth, int rowHeight) {
        this.colWidth = colWidth;
        this.rowHeight = rowHeight;
        this.title = title;
        this.workbook = new XSSFWorkbook();
    ...
    public XSSExcelTool(String title, int colWidth, int rowHeight, int flag) {
        this.colWidth = colWidth;
        this.rowHeight = rowHeight;
        this.title = title;
        this.workbook = new XSSFWorkbook();
    ...
    public XSSExcelTool(String title) {
        this.title = title;
        this.workbook = new XSSFWorkbook();
        init(0);
    }
     ...
     */
    public void createHead(List<Column> cellList, XSSFSheet sheetCo, int rowIndex) {
